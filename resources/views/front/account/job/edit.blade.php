                ...
                <div class="card-body card-form p-4">
                    ...
                    <div class="row">
                        <div class="mb-4 col-md-6">
                            ...
                            <input type="text" {{ $job->salary }} placeholder="Salary" id="salary" name="salary" class="form-control">
                        </div>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea class="form-control" name="benifits" id="benifits" cols="5" rows="5" placeholder="Benefits">{{ $job->benifits }}</textarea>
                        <p></p>
                    </div>
                    <div class="mb-4">
